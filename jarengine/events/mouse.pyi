...
class JEMouseCode(JEInternBaseClass):
    def __init__(self, mouse: Optional[int] = None) -> None: ...
...
class JEMouseWatcher(JEInternBaseClass):
    def __init__(self, on: JEMouseCode | list[JEMouseCode] | JEMouseCodeGroup, do: Callable[[JEGame, JEEvent], None], on_press: JEBool = JEBool(1)) -> None: ...
