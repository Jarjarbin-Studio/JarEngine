...
class JEOutlineComponent:
    def __init__(self, owner: JEEntity, color: JEColor | tuple[int, int, int] | tuple[int, int, int, int], size: int) -> None: ...
    @property
    def color(self) -> JEColor: ...
    @color.setter
    def color(self, color: JEColor | tuple[int, int, int] | tuple[int, int, int, int]) -> None: ...
    @property
    def size(self) -> int: ...
    @size.setter
