...
|----------|-----------|----------------------------------------------|:---------:|
| `type`   | `Type[T]` | Original type of the stored object           |   True    |
| `frozen` | `Any`     | Frozen internal representation of the object |   True    |
| `data`   | `T`       | Unfrozen copy of the stored object           |   True    |
